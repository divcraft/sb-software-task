    ...
    <>
      <div className="md:hidden fixed bottom-4 right-4 z-50">
        ...
        >
          ...
          <span className="bg-white text-indigo-700 text-xs px-2 py-1 rounded">{resolvedLength}</span>
        </button>
      </div>
        ...
        <div className="fixed inset-0 z-50 flex">
          ...
          <div className="ml-auto w-full max-w-md bg-white h-full shadow-xl p-4 overflow-auto">
            <div className="flex items-center justify-between mb-3">
              ...
              <button className="text-gray-600" onClick={() => setOpen(false)} aria-label="Close">
                ✕
              </button>
            </div>
